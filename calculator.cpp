    ...
    ui(new Ui::Calculator)
{
    ...
    // Put 0.0 in Display text box -Line Edit
    ui->Display->setText(QString::number(calcVal));

    // numButtonsWill hold references to all the number buttons from 0 to 9
...
void Calculator::NumPressed(){
    ...
    if((displayVal.toDouble() == 0) || (displayVal.toDouble() == 0.0)){
        ...
        // Put the new number to the right of whats there(displaying entered digit to the right of existing digits in display
...
void Calculator::ChangeNumberSign(){
    ...
    // If it is a number ,then only change the sign
